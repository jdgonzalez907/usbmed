    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="login">
            <form method="post" id="frmIniciarSesion">
                ...
                <a href="<?= URL ?>usuario/recordarClave<?= (isset($controlador) ? '/' . $controlador : '') . (isset($accion) ? '/' . $accion : '') ?>" class="btn btn-default pull-right"><span class="glyphicon glyphicon-question-sign"></span> No tengo clave</a>
